...
{
    public interface ITesterDataBaseOperation
    {

        string DataBaseConnectionString { get; }
        bool IsDataBaseEnable { get; }
        ...
        //void CreateAccessDTable(string filePath, string tableName, params ADOX.Column[] colums);
        ...
        /// <param name="filePath">数据库地址</param>
        /// <param name="TableName">表名</param>
        /// <param name="sqlHeader">固定列表名</param>
        /// <param name="sqlValues">固定列表名对应的值</param>
        /// <param name="summarydata">产品测试数据</param>
