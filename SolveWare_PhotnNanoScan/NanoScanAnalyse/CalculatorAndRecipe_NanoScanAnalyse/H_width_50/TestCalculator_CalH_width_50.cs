...
namespace SolveWare_TestPackage
{
    ...
    /// 
    /// </summary>
    public class TestCalculator_CalH_width_50 : TestCalculatorBase
    {
        public TestCalculator_CalH_width_50() : base() { } 
        ...
        public override void Run(IRawDataBaseLite rawData, ref List<SummaryDatumItemBase> summaryDataWithoutSpec, CancellationToken token)
        {
            try
            {
                ...
                {
                    dataSummary_1.Name = string.Format(rawData.RawDataFixFormat, $"{CalcRecipe.CalcData_PreFix}CalH_width_50{CalcRecipe.CalcData_PostFix}");
                }
                ...
                double resultCurrent = AllNanoScanAnalyse.CalculatoWidth(MoveDistance_mm, dict[X_Position_1st], dict[X_Amplitude_1st],dict[Y_Amplitude_1st], 
                                       dict[X_Amplitude_2nd], dict[Y_Amplitude_2nd]).H_width_50;
