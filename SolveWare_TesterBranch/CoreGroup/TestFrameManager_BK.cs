...
//            return confObj;
//        }
//        //public TestExecutorCombo CreateTestExecutorCombo(string comboName, string applicableTestPlugin)
//        //{
//        //    TestExecutorCombo confObj = new TestExecutorCombo();
//        //    confObj.Name = comboName;
//        //    //confObj.ApplicableTestPlugin = applicableTestPlugin;
//        //    return confObj;
//        //}
...
//        ///// <returns></returns>
//        //public object LoadInstanceFromFile_ByXmlRoot(string directoryPath, string fileName)
//        //{
//        //    string filepath = string.Empty;
//        //    if (!this.IsFileExist(directoryPath, fileName, out filepath))
//        //    {
...
//        //        var type = this._coreInteration.GetTypeFromClassInPreLoadDlls(rootNode);
...
//        /// <param name="typeList">检索集合</param>
//        /// <returns>返回在集合中可以检索到的内容</returns>
//        public List<string> GetSpecXmlFileNameFromDirect(string directoryPath, List<string> typeList)
//        {
//            try
//            {
//                if (!IsDirectExist(directoryPath))
//                {
//                    throw new Exception($"当前检索文件目录[{directoryPath}]不存在，请检查！");
//                }
//                var files = Directory.GetFiles(directoryPath, "*.XML");
//                List<string> specXmlFile = new List<string>();
//                foreach (var item in files)
//                {
//                    var temp = XElement.Load(item);
//                    var rootNode = temp.Name.ToString();
//                    if (typeList.Contains(rootNode))
//                    {
//                        specXmlFile.Add(Path.GetFileNameWithoutExtension(item));
//                    }
//                }
//                return specXmlFile;
//            }
...
//        {
//            var path = this._coreInteration.StationConfig.GetSystemParamsValue(TesterKeyPathsAndFiles.CALC_RECIPE_PATH);
//            if (Directory.Exists(path) == false)
//            {
...
//        {
//            var path = this._coreInteration.StationConfig.GetSystemParamsValue(TesterKeyPathsAndFiles.TEST_RECIPE_PATH);
//            if (Directory.Exists(path) == false)
//            {
