...
{
    public class TestRecipe_Coupling_PD : TestRecipeBase
    {
        public TestRecipe_Coupling_PD()
        {
            UsedCurrentPos = false;
            Position = "Coupling_PD开始点";
            LightSource_Model = "Golight";
            LightSource_Channel = 1;
            Wavelength = 850.0;
            Analog_CH = 3;
            Voltage_V = 3;
            Compliance_mA = 5;
        ...
        [DisplayName("光源型号")]
        [Description("LightSource_Model")]
        [PropEditable(true)]
        public string LightSource_Model { get; set; }

        [DisplayName("通道编号1-X")]
        [Description("LightSource_Channel")]
        [PropEditable(true)]
        public int LightSource_Channel { get; set; }
        ...
        [DisplayName("PD反向偏压(V)")]
        [Description("Voltage_V")]
        [PropEditable(true)]
        public double Voltage_V { get; set; }

        [DisplayName("限制电流(mA)")]
        [Description("Compliance_mA")]
        [PropEditable(true)]
        public double Compliance_mA { get; set; }

        [DisplayName("输出光功率(mW)")]
        [Description("LightPower_mW")]
        [PropEditable(true)]
        public double LightPower_mW { get; set; }
