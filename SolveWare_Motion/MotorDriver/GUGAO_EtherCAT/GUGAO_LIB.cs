...
{
    public enum EXT_IO_CTRL_MODE : short
    {
        重置状态_DLL = 0,
        重置状态_DSP = 1,
        保持原有状态_DLL = 2,
    ...
    #region GUGAO_LIB
    public partial class GUGAO_LIB
    {
        ...
        [DllImport("gts.dll")]
        public static extern short GTN_EcatSDODownloadEx(short core, ushort slave, ushort index, byte subindex, ref byte data, uint data_size, ref uint abort_code);
        [DllImport("gts.dll")]
        ...
        [DllImport("gts.dll")]
        public static extern short GTN_EcatSDOUploadEx(short core, ushort slave, ushort index, byte subindex, ref byte target, uint target_size, ref uint result_size, ref uint abort_code);
        [DllImport("gts.dll")]
