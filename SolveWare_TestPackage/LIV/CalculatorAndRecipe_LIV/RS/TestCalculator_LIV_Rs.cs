...
namespace SolveWare_TestPackage
{
    ...
    /// </summary>
    public class TestCalculator_LIV_Rs : TestCalculatorBase
    {
        public TestCalculator_LIV_Rs() : base() { }

        public CalcRecipe_LIV_Rs CalcRecipe { get; private set; }

        public override Type GetCalcRecipeType()
        {
            return typeof(CalcRecipe_LIV_Rs);
        }

        public override void Localization(ICalcRecipe testRecipe)
        {
            CalcRecipe = (CalcRecipe_LIV_Rs)(testRecipe);
        }
        ...
        public override void Run(IRawDataBaseLite rawData, ref List<SummaryDatumItemBase> summaryDataWithoutSpec, CancellationToken token)
        {
            try
            {
                ...
                {
                    dataSummary_1.Name = string.Format(rawData.RawDataFixFormat, $"{CalcRecipe.CalcData_PreFix}Rs{CalcRecipe.CalcData_PostFix}");
                }
                ...
                {
                    throw new Exception($"Rs: xArray and yArray are of unequal size!");
                }
            ...
            {
                this._core.ReportException($"{this.Name} - {ex.Message}", ErrorCodes.Calc_LIV_Rs_ParamError, ex);
            }
        }
    }
}