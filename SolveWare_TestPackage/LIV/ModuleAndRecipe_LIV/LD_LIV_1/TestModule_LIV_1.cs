...
namespace SolveWare_TestPackage
{
    ...
    #endregion
    public class TestModule_LIV_1 : TestModuleBase
    {

        public TestModule_LIV_1() : base() { }
        ...
        TestRecipe_LIV_1 TestRecipe { get; set; }
        RawData_LIV RawData { get; set; }
        public override Type GetTestRecipeType()
        {
            return typeof(TestRecipe_LIV_1);
        }
        ...
        {
            TestRecipe = ConvertObjectTo<TestRecipe_LIV_1>(testRecipe);
        }
        public override void Run(CancellationToken token)
        {
            try
            {
                ...
                //{
                //    this.Log_Global($"Start LIV sweep ...{this.TestRecipe.I_Start_A}~{this.TestRecipe.I_Stop_A}mA " +
                //                                 $"step  {this.TestRecipe.I_Step_A}mA, " +
                //                          $"EA Voltage = {this.TestRecipe.EAVoltage_V}V");
                //    SourceMeter_Master.Sweep_LD_EA_PD(Convert.ToSingle(this.TestRecipe.I_Start_A),
                //                       Convert.ToSingle(this.TestRecipe.I_Step_A),
                //                       Convert.ToSingle(this.TestRecipe.I_Stop_A),
                ...
                //{
                //    this.Log_Global($"Start LIV sweep ...{this.TestRecipe.I_Start_A}~{this.TestRecipe.I_Stop_A}mA step {this.TestRecipe.I_Step_A}mA, MPD Voltage = {this.TestRecipe.MPDBiasVoltage}V");
                //    SourceMeter_Master.Sweep_LD_MPD_PD(Convert.ToSingle(this.TestRecipe.I_Start_A),
                //                        Convert.ToSingle(this.TestRecipe.I_Step_A),
                //                        Convert.ToSingle(this.TestRecipe.I_Stop_A),
                //                        Convert.ToSingle(this.TestRecipe.complianceVoltage_V),
                ...
                SourceMeter_Master.Sweep_LD_PD(Convert.ToSingle(this.TestRecipe.I_Start_A * 1000),
                ...
                RawData.I_Start_mA = this.TestRecipe.I_Start_A * 1000;
                RawData.I_Step_mA = this.TestRecipe.I_Step_A * 1000;
                RawData.I_Stop_mA = this.TestRecipe.I_Stop_A * 1000;
            }
            catch (Exception ex)
            {
            }
