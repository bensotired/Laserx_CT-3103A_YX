...
namespace SolveWare_TestPackage
{
    ...
    /// 找出目标电流点下对应的器件输出功率
    /// </summary>
    public class TestCalculator_LIV_Tap_PD_Ith1_MultiRawData : TestCalculatorBase
    {
        public TestCalculator_LIV_Tap_PD_Ith1_MultiRawData() : base() { }

        public CalcRecipe_LIV_Tap_PD_Ith1_MultiRawData CalcRecipe { get; private set; }

        public override Type GetCalcRecipeType()
        {
            return typeof(CalcRecipe_LIV_Tap_PD_Ith1_MultiRawData);
        }

        public override void Localization(ICalcRecipe testRecipe)
        {
            CalcRecipe = (CalcRecipe_LIV_Tap_PD_Ith1_MultiRawData)(testRecipe);
        }
            ...
            try
            {
                if (rawData is IRawDataMenuCollection)
                {
                    ...
                    foreach (var item in rawdata)
                    {
                        ...
                        dataSummary_1.Name = $"{CalcRecipe.CalcData_PreFix}Tap_PD_Ith1{CalcRecipe.CalcData_PostFix}";
