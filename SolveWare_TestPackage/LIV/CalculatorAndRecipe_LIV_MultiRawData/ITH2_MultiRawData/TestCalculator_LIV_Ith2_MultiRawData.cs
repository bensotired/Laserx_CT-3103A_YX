...
namespace SolveWare_TestPackage
{
    ...
    /// 找出目标电流点下对应的器件输出功率
    /// </summary>
    public class TestCalculator_LIV_Ith2_MultiRawData : TestCalculatorBase
    {
        public TestCalculator_LIV_Ith2_MultiRawData() : base() { }

        public CalcRecipe_LIV_Ith2_MultiRawData CalcRecipe { get; private set; }

        public override Type GetCalcRecipeType()
        {
            return typeof(CalcRecipe_LIV_Ith2_MultiRawData);
        }

        public override void Localization(ICalcRecipe testRecipe)
        {
            CalcRecipe = (CalcRecipe_LIV_Ith2_MultiRawData)(testRecipe);
        }
            ...
            try
            {
                if (rawData is IRawDataMenuCollection)
                {
                    ...
                    foreach (var item in rawdata)
                    {
                        ...
                        dataSummary_1.Name = $"{CalcRecipe.CalcData_PreFix}LIV_Ith2{CalcRecipe.CalcData_PostFix}";
