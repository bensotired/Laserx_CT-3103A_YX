...
{
    public class TestCalculator_SPECT : TestCalculatorBase
    {
        public TestCalculator_SPECT() : base() { }
        public CalcRecipe_SPECT CalcRecipe { get; private set; }
        public override Type GetCalcRecipeType()
        {
            return typeof(CalcRecipe_SPECT);
        }

        public override void Localization(ICalcRecipe testRecipe)
        {
            CalcRecipe = (CalcRecipe_SPECT)testRecipe;
        }
