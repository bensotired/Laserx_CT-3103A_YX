...
{
    [Serializable]
    public class TestRecipe_FF : TestRecipeBase
    {
        public TestRecipe_FF()
        {
            this.Current_A = 1;
            this.IsLeftShort = true;
            this.ShortSpeed = 100;
            this.IsLeftLong = true;
            this.LongSpeed = 100;
        ...
        [DisplayName("左短摆臂FarField")]
        [PropEditable(true)]
        public bool IsLeftShort { get; set; }
