...
{
    public class TestCalculator_TED : TestCalculatorBase
    {
        public TestCalculator_TED() : base() { }
        public CalcRecipe_TED CalcRecipe { get; private set; }
        public override Type GetCalcRecipeType()
        {
            return typeof(CalcRecipe_TED);
        }

        public override void Localization(ICalcRecipe testRecipe)
        {
            CalcRecipe = (CalcRecipe_TED)testRecipe;
        }
