...
{
    public class TestCalculator_IRev : TestCalculatorBase
    {

        public TestCalculator_IRev() : base() { }
        public CalcRecipe_IRev CalcRecipe { get; private set; }
        public override Type GetCalcRecipeType()
        {
            return typeof(CalcRecipe_IRev);
        }

        public override void Localization(ICalcRecipe testRecipe)
        {
            CalcRecipe = (CalcRecipe_IRev)testRecipe;
        }
