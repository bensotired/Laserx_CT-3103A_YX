...
namespace SolveWare_TestPackage
{
    ...
    /// 找出目标电流点下对应的器件输出功率
    /// </summary>
    public class TestCalculator_LIV_Ith1 : TestCalculatorBase
    {
        public TestCalculator_LIV_Ith1() : base() { }

        public CalcRecipe_LIV_Ith1 CalcRecipe { get; private set; }

        public override Type GetCalcRecipeType()
        {
            return typeof(CalcRecipe_LIV_Ith1);
        }

        public override void Localization(ICalcRecipe testRecipe)
        {
            CalcRecipe = (CalcRecipe_LIV_Ith1)(testRecipe);
        }
