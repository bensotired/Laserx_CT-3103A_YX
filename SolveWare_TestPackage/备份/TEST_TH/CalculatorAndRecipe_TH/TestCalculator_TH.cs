...
namespace SolveWare_TestPackage
{
    ...
    /// 电阻计算
    /// </summary>
    public class TestCalculator_TH : TestCalculatorBase
    {
        public TestCalculator_TH() : base() { }

        public CalcRecipe_TH CalcRecipe { get; private set; }

        public override Type GetCalcRecipeType()
        {
            return typeof(CalcRecipe_TH);
        }

        public override void Localization(ICalcRecipe testRecipe)
        {
            CalcRecipe = (CalcRecipe_TH)testRecipe;
        }
