...
{
    public class TestCalculator_QWLT2 : TestCalculatorBase
    {
        public TestCalculator_QWLT2() : base() { }
        public CalcRecipe_QWLT2 CalcRecipe { get; private set; }
        public override Type GetCalcRecipeType()
        {
            return typeof(CalcRecipe_QWLT2);
        }

        public override void Localization(ICalcRecipe testRecipe)
        {
            CalcRecipe = (CalcRecipe_QWLT2)testRecipe;
        }
