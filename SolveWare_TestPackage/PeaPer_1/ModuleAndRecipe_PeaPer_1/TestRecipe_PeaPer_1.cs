...
{
    [Serializable]
    public class TestRecipe_PeaPer_1 : TestRecipeBase
    {
        public TestRecipe_PeaPer_1()
        {
        ...
        //[DisplayName("采样时间(毫秒)")]
        //[Description("AcqTime_ms")]
        //[PropEditable(true)]
        //public int AcqTime_ms { get; set; }
        ...
        [DisplayName("第一扇区偏振片旋转扫描起始负方向角度偏移量")]
