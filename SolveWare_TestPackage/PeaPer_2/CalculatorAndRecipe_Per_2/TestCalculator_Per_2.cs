...
{
    public class TestCalculator_Per_2 : TestCalculatorBase
    {
        public TestCalculator_Per_2() : base() { }
        public CalcRecipe_Per_2 CalcRecipe { get; private set; }
        public override Type GetCalcRecipeType()
        {
            return typeof(CalcRecipe_Per_2);
        }

        public override void Localization(ICalcRecipe testRecipe)
        {
            CalcRecipe = (CalcRecipe_Per_2)testRecipe;
        }
